 ...
 */
class Abscent extends \AppBundle\Entity\Abscent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Abscent' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Abscent' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Abscent' . "\0" . 'enfant', '' . "\0" . 'AppBundle\\Entity\\Abscent' . "\0" . 'motif'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Abscent $proxy) {
