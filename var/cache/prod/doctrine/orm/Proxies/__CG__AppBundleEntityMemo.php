 ...
 */
class Memo extends \AppBundle\Entity\Memo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Memo' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Memo' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\Memo' . "\0" . 'htmlid', '' . "\0" . 'AppBundle\\Entity\\Memo' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Memo' . "\0" . 'dateCreation', '' . "\0" . 'AppBundle\\Entity\\Memo' . "\0" . 'etat'];
        }
    ...
    public function getHtmlid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHtmlid', []);
    ...
    public function setHtmlid($htmlid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHtmlid', [$htmlid]);
