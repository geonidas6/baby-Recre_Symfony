 ...
 */
class Assurance extends \AppBundle\Entity\Assurance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Assurance' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Assurance' . "\0" . 'enfant', '' . "\0" . 'AppBundle\\Entity\\Assurance' . "\0" . 'paiement', '' . "\0" . 'AppBundle\\Entity\\Assurance' . "\0" . 'datedebut', '' . "\0" . 'AppBundle\\Entity\\Assurance' . "\0" . 'datefin'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Assurance $proxy) {
